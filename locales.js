...
(function () {
  ...
  var LOCALES = {
    pl: {
      ...
      minigame_instruction_dodge: 'Poczekaj na napis „UNIK!”. Gdy się pojawi – kliknij przycisk poniżej (lub w dowolne miejsce) w ciągu pół sekundy. 2 sukcesy z 3.',
    ...
    en: {
      ...
      minigame_instruction_dodge: 'Wait for the "DODGE!" text. When it appears – tap the button below (or anywhere) within half a second. 2 out of 3.',
