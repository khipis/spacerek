...
(function () {
  ...
  var LOCALES = {
    pl: {
      ...
      minigame_instruction_timing: 'Kolorowy pasek jeździ w lewo i prawo. Zadanie: kliknij W DOWOLNE MIEJSCE NA RAMCE (obszar paska), dokładnie gdy ten pasek wejdzie w ZIELONĄ STREFĘ. 2 trafienia z 3.',
      minigame_instruction_dodge: 'Nie klikaj za wcześnie! Poczekaj, aż pojawi się wielki napis „UNIK!” – wtedy od razu kliknij przycisk poniżej. Masz na to pół sekundy. 2 z 3.',
      minigame_dodge_tap_btn: 'Kliknij gdy zobaczysz UNIK!',
      ...
      minigame_instruction_stop: 'Pasek wypełnia się od lewej do prawej. Gdy czoło wypełnienia (kolor) dojdzie do ZIELONEGO OBSZARU – naciśnij STOP. Za wcześnie lub za późno = pudło. 2 z 3.',
      minigame_stop_btn: 'STOP',
      minigame_instruction_reaction: 'Przycisk jest zablokowany. Gdy pojawi się napis „KLIKNIJ!” – odblokuje się. Wtedy natychmiast kliknij przycisk poniżej. 2 z 3.',
      ...
      experience_section_defeats: 'Porażki (stracone XP)',
    ...
    en: {
      ...
      minigame_instruction_timing: 'The coloured bar moves left and right. Task: tap ANYWHERE on the bar area exactly when the bar is inside the GREEN ZONE. 2 out of 3.',
      minigame_instruction_dodge: "Don't tap too early! Wait until the big 'DODGE!' text appears – then tap the button below immediately. You have half a second. 2 out of 3.",
      minigame_dodge_tap_btn: 'Tap when you see DODGE!',
      ...
      minigame_tap_go: 'Go!',
      minigame_instruction_stop: 'The bar fills from left to right. When the front of the fill reaches the GREEN ZONE – press STOP. Too early or too late = miss. 2 out of 3.',
      minigame_stop_btn: 'STOP',
      minigame_instruction_reaction: 'The button is locked. When the "CLICK!" text appears – it unlocks. Then tap the button below immediately. 2 out of 3.',
      ...
      experience_section_defeats: 'Defeats (XP lost)',
